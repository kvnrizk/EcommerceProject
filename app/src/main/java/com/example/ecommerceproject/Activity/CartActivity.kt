...
import com.example.ecommerceproject.Helper.ChangeNumberItemsListener
...
@Composable
fun CartList(cartItems: ArrayList<ItemsModel>, managmentCart: ManagmentCart, onItemCgange:()-> Unit) {
...
fun CartItem(
    ...
    modifier = Modifier
        ...
        Text(text="$${item.price}",
            color = colorResource(R.color.darkGrey), modifier = Modifier
